        ...
        if control_type == "depth":
            ...
            if self.control_pose_model is None:
                ...
                try:
                    ...
                    self.control_pose_model = DWposeDetector(device=str(device))
                except ImportError:
                    raise ImportError(
            ...
            input_images = (
                transform_image(img).unsqueeze(0).to("cuda").to(torch.float16)
            )
...
if __name__ == "__main__":
    ...
    control_times = {"depth": 0, "pose": 0, "line": 0, "inpaint": 0, "mask": 0}
    ...
    parser.add_argument("--regen", action="store_true", help="Regenerate all controls")
    ...
    for control in controls:
        ...
        print(f"Avg time for {control} control: {control_times[control]:.2f} seconds")
